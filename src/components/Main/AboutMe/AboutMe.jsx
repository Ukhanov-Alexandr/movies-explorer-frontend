...
import photo from '../../../images/ant-120.jpg';
// import photo from '../../../images/ant-121.jpg';
// import photo from '../../../images/ant-20.jpg';
    ...
    <section className="two-columns about-me__columns">
      <div className="two-columns__column about-me__column about-me__content">
        <div className="about-me__description">
          ...
          <h3 className="about-me__subheader">Фронтенд-разработчик, 27 лет</h3>
